        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="rounded-[13px] border px-3.5 py-3" style={{ borderColor: activeAi ? "var(--border)" : "var(--warning)", background: activeAi ? "var(--surface-2)" : "var(--warning-soft)" }}>
            <div className="flex items-center justify-between gap-3">
              ...
              <button type="button" role="switch" aria-checked={activeAi} aria-label="AI javoblarini yoqish yoki o'chirish" onClick={() => toggleGlobalAi(!activeAi)} disabled={!canControl("ai_settings") || globalLoading || globalSaving} className="relative h-[31px] w-[51px] shrink-0 rounded-full p-0.5 transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-50" style={{ background: activeAi ? "var(--primary)" : "#9a9a9f", boxShadow: activeAi ? "inset 0 0 0 1px color-mix(in srgb, var(--primary) 65%, #000 10%)" : "inset 0 0 0 1px rgba(0,0,0,.12)" }}><span className="block h-[27px] w-[27px] rounded-full bg-white shadow-[0_2px_5px_rgba(0,0,0,.25)] transition-transform duration-200" style={{ transform: activeAi ? "translateX(20px)" : "translateX(0)" }} /></button>
            </div>
