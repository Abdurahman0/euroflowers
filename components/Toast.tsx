    ...
    <AnimatePresence>
      {toast && (
        <motion.div
          ...
          // ko'p qatorli `detail` massivi ham to'liq o'qiladi: qatorlar saqlanadi
          // (bitta qator bo'lsa ko'rinish o'zgarmaydi — pilyulya o'sha-o'sha)
          className="fixed bottom-6 left-1/2 z-[100] max-w-[min(560px,90vw)] whitespace-pre-line rounded-[22px] border px-6 py-3 text-center text-[14px] font-semibold shadow-2xl"
